...
## Задание 4 (25 баллов)
В данном задании выполнена оптимизация параметров запуска CUDA-ядра для одной из ранее разработанных программ.
В ходе работы были подобраны значения размера блока потоков и конфигурации сетки, обеспечивающие более эффективное выполнение вычислений.
